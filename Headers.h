...
@class BBAction, BBObserver, BBAssertion, BBAttachments, BBSound;

@interface BBContent : NSObject <NSCopying, NSCoding>
@property (copy, nonatomic) NSString *message;
@property (copy, nonatomic) NSString *subtitle;
@property (copy, nonatomic) NSString *title;
+ (id)contentWithTitle:(NSString *)title subtitle:(NSString *)subtitle message:(NSString *)message;
- (BOOL)isEqualToContent:(BBContent *)content;
@end
